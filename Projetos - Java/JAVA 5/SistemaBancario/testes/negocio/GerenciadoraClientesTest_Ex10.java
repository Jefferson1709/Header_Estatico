...
public class GerenciadoraClientesTest_Ex10 {
	...
	public void setUp() {
		...
		Cliente cliente01 = new Cliente(idCLiente01, "Jefferson santos", 27, "Jefferson@gmail.com", 1, true);
		Cliente cliente02 = new Cliente(idCLiente02, "Jose Raimundo", 62, "jose@gmail.com", 1, true);
	...
	public void testClienteIdadeAceitavel() throws IdadeNaoPermitidaException {
		...
		/* ========== Montagem do Cenario ========== */		
		Cliente cliente = new Cliente(1, "Jefferson", 25, "Jefferson@gmail.com", 1, true);
	...
	public void testClienteIdadeAceitavel_02() throws IdadeNaoPermitidaException {
		...
		/* ========== Montagem do Cenario ========== */		
		Cliente cliente = new Cliente(1, "Jefferson", 18, "Jefferson@gmail.com", 1, true);
	...
	public void testClienteIdadeAceitavel_03() throws IdadeNaoPermitidaException {
		...
		/* ========== Montagem do Cenario ========== */		
		Cliente cliente = new Cliente(1, "Jefferson", 65, "Jefferson@gmail.com", 1, true);
	...
	public void testClienteIdadeAceitavel_04() throws IdadeNaoPermitidaException {
		...
		/* ========== Montagem do Cenario ========== */		
		Cliente cliente = new Cliente(1, "Jefferson", 17, "Jefferson@gmail.com", 1, true);
	...
	public void testClienteIdadeAceitavel_05() throws IdadeNaoPermitidaException {
		...
		/* ========== Montagem do Cenario ========== */		
		Cliente cliente = new Cliente(1, "Jefferson", 66, "Jefferson@gmail.com", 1, true);
		/* ========== Execucao ========== */
		try {
			gerClientes.validaIdade(cliente.getIdade());
			fail();
